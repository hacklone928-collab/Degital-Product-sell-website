      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-center gap-6 sm:gap-8">
          <div className="flex flex-col items-center md:items-start gap-3 sm:gap-4">
            <Link to="/" className="text-lg sm:text-xl font-bold tracking-tighter text-indigo-600">
              {settings.siteName}
            </Link>
          ...
          <div className="flex flex-wrap justify-center gap-x-6 sm:gap-x-8 gap-y-2 text-xs sm:text-sm font-medium text-gray-600">
