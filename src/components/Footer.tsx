...
export default function Footer() {
  ...
  return (
    <footer className="bg-gray-50 border-t border-gray-100 pt-8 pb-24 sm:py-16 w-full overflow-hidden">
              ...
              <div className="flex items-center gap-4">
                {settings.socialLinks.map((social, idx) => (
                  <a 
                    ...
                    className="w-8 h-8 sm:w-10 sm:h-10 rounded-xl sm:rounded-2xl bg-white border border-gray-100 flex items-center justify-center text-gray-400 hover:text-indigo-600 hover:border-indigo-100 hover:shadow-xl hover:shadow-indigo-500/5 transition-all group"
